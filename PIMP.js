/*
*** PIMP MY PROFILE v09.02.2019.08 ***
*/
/*
VARIABLES
*/
...
$(".RightSideButton").css({backgroundImage:""});
/*
...
paige.setAttribute("poster","https://pbs.twimg.com/media/Dv8--weW0AItnqm.jpg");
...
$(".RightSideButton.tip10").tooltip({content:"Want to remove flash an install<br>an older version? Here's how"});
$(".RightSideButton.tip11").tooltip({content:"Want to find out what club was<br>used in a replay?"});
},5000);
