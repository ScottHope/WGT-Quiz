...
/*
Remove summary images and replace with div headers
*/
...
hue = Math.floor(Math.random()*multiplier+start), theme = "hsl(" + hue + ", 60%, 85%)", btnbg = "hsl(" + (hue + 20) + ", 60%, 85%)", wgtmenu = "hsl(" + hue + ", 60%, 75%)", tooltipbg = "hsla(" + hue + ", 60%, 20%, 0.7)", tools = "hsl(" + hue + ", 60%, 60%)", nubtn = "hsl(" + (hue - 90) + ", 60%, 85%)", modalbg = "hsla(" + hue + ", 60%, 5%, 0.7)", darkmain = "hsl(" + hue + ", 60%, 25%)";
